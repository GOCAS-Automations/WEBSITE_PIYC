 ...
 * guarda el video de un servicio (`site_services.video`) y la capa de contenido
 * que lo lee. El id nunca se guarda: se deriva de la URL al leer.
 *
 * Existe porque quien edita el panel **pega la URL de la barra del navegador**,
 * no el identificador, y esa URL viene en varias formas según de dónde se copie
 * (escritorio, botón Compartir, YouTube Studio, Shorts).
 */
