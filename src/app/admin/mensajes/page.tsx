        ...
        <>
          <ul id="lista-mensajes" className="scroll-mt-8 space-y-3">
            {pagina.visibles.map((mensaje) => (
              <li
                key={mensaje.id}
                className="rounded-tarjeta bg-blanco p-4 shadow-tarjeta sm:p-5"
              >
                <div className="flex flex-wrap items-start justify-between gap-3">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <Insignia className={CHIP_NEUTRO}>{formatearFechaLarga(mensaje.created_at)}</Insignia>
                    <a
                ...
                <p className="mt-3 whitespace-pre-line rounded-control bg-lienzo-alto px-4 py-3 text-sm leading-relaxed text-acero-700">
                  {mensaje.mensaje}
                </p>

                <dl className="mt-3 flex flex-wrap gap-x-6 gap-y-1 border-t border-separador pt-3 text-sm">
